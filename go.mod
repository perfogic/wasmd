...
replace (
	...
	// go list -m -json github.com/oraichain/wasmvm@d3fcf3c | jq '.Version' -r
	github.com/CosmWasm/wasmvm => github.com/oraichain/wasmvm v1.1.4-0.20231122084957-d3fcf3c1b7af
