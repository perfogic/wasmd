...
func NewWasmApp(
	...
	*/
	...
	wasmHooks := ibchooks.NewWasmHooks(app.IBCHooksKeeper, &app.WasmKeeper, prefix) // The contract keeper needs to be set later
	...
	app.ICAHostKeeper = icahostkeeper.NewKeeper(
		...
		app.HooksICS4Wrapper, // use ics29 fee as ics4Wrapper in middleware stack
		app.IBCKeeper.ChannelKeeper,
		&app.IBCKeeper.PortKeeper,
		app.AccountKeeper,
		scopedICAHostKeeper,
	...
	// let ibcfee run after packetforward
...
func (app *WasmApp) upgradeHandler() {
